...
plt.savefig('../../figs/ch3/bpsk_map_density.pdf')
plt.savefig('../../figs/ch3/bpsk_map_density.png')

#if using termux
#subprocess.run(shlex.split("termux-open ../../figs/ch3/bpsk_map_density.pdf"))
#else
